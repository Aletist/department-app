...
class ClientConfig(Config):
    # root_path = '/home/alexey/PycharmProjects/department-app'
...
class DeployConfig():
    project_dir = '/'
    environment = '/home/travis/virtualenv/bin'
    user = 'travis'
    dev = True


class ApiConfig():
    service_name = 'api-department-app'
    conf_location = '/etc/systemd/system/api-department-app.service'
...
class WebConfig():
    service_name = 'www-department-app'
